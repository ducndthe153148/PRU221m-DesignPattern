...
public class Client : MonoBehaviour
{
    ...
    public void AssignFactoryToBuilding()
    {
        ...
        {
            case "Building A":
                CreateFactoryBuildingAndShip(0, FacA, out factoryBuildingTransform, out containerShipTransform);
                break;
            
            case "Building B":
                CreateFactoryBuildingAndShip(1, FacB, out factoryBuildingTransform, out containerShipTransform);
                break;
            
            case "Building C":
                CreateFactoryBuildingAndShip(2, FacC, out factoryBuildingTransform, out containerShipTransform);
                break;
        }
    ...
    private void CreateFactoryBuildingAndShip(int arrayPosition, GameObject Fac, out Transform factoryBuildingTransform, out Transform containerShipTransform)
    {
        if (_factoryBuildings[arrayPosition] == null)
        {
            // Create transforms for factory building and ship
            _factoryBuildings[arrayPosition] = CreateFactoryBuilding(Fac);
