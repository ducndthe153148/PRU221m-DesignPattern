...
public class CarFactory : VehicleFactory
{
    ...
    public override void CreateSlowVehicle()
    {
        ...
        {
            var slowCar = Instantiate(slowCarGameObject.transform, new Vector2(factoryTransformPosition.x, factoryTransformPosition.y - 2 + 0.4f), Quaternion.identity);
    ...
    public override void CreateFastVehicle()
    {
        ...
        {
            var fastCar = Instantiate(fastCarGameObject.transform, new Vector2(factoryTransformPosition.x, factoryTransformPosition.y - 2 + 0.4f), Quaternion.identity);
